 ...
 return (
  <div className="flex items-center justify-center min-h-screen">
    <form onSubmit={handleSubmit} className="space-y-4 mb-5 block w-1/2 p-2 border w-full sm:w-3/4 md:w-2/3 lg:w-1/2 border-gray-300 rounded-md px-6">
      ...
      <div className="m-6 p-6 bg-white shadow-md rounded-lg  dark:bg-primary-950">
        <label className="block text-sm font-medium dark:text-white  text-black" htmlFor="cin">
           CIN
       </label>
        <input type="text" name="cin" value={formData.cin} onChange={handleInputChange} className="shadow appearance-none  dark:bg-primary-800  border rounded w-full py-2 px-3 text-black leading-tight focus:outline-none focus:shadow-outline"  />
      </div>
      <div className="m-6 p-6 bg-white shadow-md rounded-lg  dark:bg-primary-950 ">
      ...
      <label className="block text-sm font-medium text-black dark:text-white" htmlFor="type_d_absence">Type Absence</label>
          <select name="type_d_absence" value={formData.type_d_absence} onChange={handleInputChange} className="shadow appearance-none border rounded w-full py-2 px-3 text-black leading-tight focus:outline-none focus:shadow-outline dark:bg-primary-800" >
      ...
      <button className="bg-cyan-400 text-white px-6 py-3 rounded ml-4  items-center  flex justify-end m">

    ...
    <header className="bg-gray-200 dark:bg-primary-950 text-black py-4 px-6 flex dark:text-white justify-between items-center">
      <div className="flex items-center space-x-4">
        <button
          ...
          className="md:hidden px-4 py-2 rounded-md dark:hover:bg-gray-300 hover:bg-gray-400"
        >
          <FaBars />
        </button>
      ...
      <div className="flex items-center space-x-4">
        ...
        <button
          onClick={logout}
          className="block w-full px-4 py-2 rounded-md dark:hover:bg-gray-300 hover:bg-gray-400"
        >
          <FaSignOutAlt />
        </button>
      </div>

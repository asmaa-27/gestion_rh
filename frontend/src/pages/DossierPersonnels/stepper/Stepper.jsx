...
const Stepper = () => {
  ...
  return (
    <main className="flex flex-col gap-8 h-screen overflow-hidden">
      <div className="flex flex-wrap justify-center sm:justify-between items-center mt-16 w-full overflow-x-auto">
        {steps.map((step, i) => (
          <div
            key={i}
          ...
          {!complete && (
            <button
              className={`btn btn-next ${
                currentStep === steps.length ? "btn-finish" : ""
              }`}
              onClick={() => {
